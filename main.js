...
var checkHTTPSWarning = function() {
    ...
    if(this_page_url){
        if(/https/.test(this_page_url) && has_interact_elemment){
            var warning_text = "<span>由於某些瀏覽器不再支援Flash 部分動畫檔案可能無法顯示 請到官方網站觀看更新的版本 [<a onclick='this.parentNode.style.display=\"none\";' style='color:#0000ff;cursor:pointer;'>隱藏此訊息</a>]</span>";
